...
from models_usuario.usuario import Usuario
from database import get_db
from schemas.cliente_schema import ClienteOut,CriarCliente,AtualizarCliente,DeletarCliente,CriarUsuario,LoginUsuario
from schemas.conta_schema import CriarConta,ContaOut,AtualizarConta,DeletarConta
...
async def registrar_usuario(request: CriarUsuario, db: Session = Depends(get_db)):
    ...
    novo_usuario = Usuario(username=request.username, hashed_password=senha_hash)
    db.add(novo_usuario)
    db.commit()
